...
public class EmpWageComputation {
	...
	private static EmpWageBuilder[] companies;
	...
	public static void main(String[] args) {
		...
		companies = new EmpWageBuilder[num];
		
		for (int i = 0; i < num; i++) {
			takeCompanyDetails();
			companies[i] = new EmpWageBuilder(companyName, wagePerHour, perCompanyDays, perCompanyHours);
		}
